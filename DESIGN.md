...
- **ทางออกหลอก (ออกนอกสนาม):** หลังเข้าช่องใหม่ ถ้า
  ...
  2. ToF ≥ 2 ทิศ (ไม่นับทางที่มา) อ่านได้ "ผิดปกติ" = ไม่มีค่า / ไกลเกิน 3 ม. / **ไม่ลงเส้น grid**
     (ในเขาวงกตผิวกำแพงอยู่ที่ ขอบช่อง + k×0.6 ม. เสมอ ของในห้องอยู่ระยะไหนก็ได้)
  3. หันดูซ้ำ ±20° ก็ยังไม่เจอกำแพง
  → ถือว่าออกนอกสนาม: ถอยกลับตามทางเดิมจนถึงช่องที่มีกำแพง ตัดช่องนอกสนามออกจากแผนที่ แล้ว**จบภารกิจ**
  (`exploration.on_exit = "stop"`; ตั้ง `"continue"` เพื่อสำรวจส่วนที่เหลือต่อ)
  - sim (ห้องล้อมสนามระยะสุ่มแต่ละด้าน): จับผิดในเขาวงกตปิด 0/30, จับทางออกถูก 27/30
